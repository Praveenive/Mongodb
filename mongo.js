...
db.products.find().forEach(function(product){print("Product Name:",product.product_name,"Product Material:",product.product_material)})
...
// db.products.find().forEach(function(prod){print(prod.product_price)})
